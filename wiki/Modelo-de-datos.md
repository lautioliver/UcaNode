...
| Capa | Ubicación | Rol |
|---|---|---|
| Fuente JSON | `src/data/correlatividades.json` (Informática 2015); otras carreras en `src/data/planes/{slug}.json` (p. ej. `ingenieria-civil-2012.json`, `licenciatura-en-relaciones-internacionales-2026.json`) | Datos canónicos del plan |
