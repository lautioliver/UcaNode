...
| `campus/page.tsx` | Mapa interactivo del Campus Castañares |
...
| `campus-map.tsx` | Mapa del campus con marcadores interactivos y zoom |
| `campus-workspace.tsx` | Vista `/campus`: filtros y listado de los 21 edificios |
| `proxima-clase-card.tsx` | Widget de próxima clase con modal del mapa |
...
| `campus/edificios.ts` | Diccionario de edificios, servicios y coordenadas del mapa del campus |
| `horario-utils.ts` | Clase en curso o próxima, en la zona horaria del campus |
...
| Ruta | Uso |
|---|---|
| `public/images/mapa-ucasal-castanares.webp` | Mapa oficial del Campus Castañares usado por `/campus` |
